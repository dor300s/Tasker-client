...
export class AddCardForm extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div className="card-list-container add-card flex justify-center align-center" onClick={this.openForm} >
                    {!addCardForm ? <div className="card-preview">Create new card</div> :
